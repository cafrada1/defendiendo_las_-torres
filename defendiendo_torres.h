...
#define MAX_RUTA 50
#define MAX_CLAVE 50
#define MAX_FORMATO 50
#define MAX_TIPO 30
#define MAX_DATOS 500

#define NO_INGRESADO -1
#define RUTA_NO_INGRESADA "-1"

#define CANTIDAD_NIVELES 4
#define CANTIDAD_CAMINOS 2
#define CANTIDAD_EXTRAS 3
...
typedef struct configuracion{
	...
	int enanos_extras[CANTIDAD_EXTRAS];
	int elfos_extras[CANTIDAD_EXTRAS];
